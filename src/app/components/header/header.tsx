...
export default function Header() {
  ...
  const linkClass = (path: string) =>
    `px-1.5 min-[550px]:px-3 py-0.5 min-[550px]:py-1 rounded-md text-[10.5px] min-[375px]:text-[13px] min-[425px]:text-[14px] min-[550px]:text-[16px] min-[768px]:text-[18px] min-[1024px]:text-[20px] min-[1440px]:text-[22px] font-bold transition-all duration-200
  ${
      pathname === path
        ? "bg-pink-400 text-black shadow-sm"
        : "text-white bg-pink-50/10 hover:text-black hover:bg-pink-400 hover:shadow-sm"
    }`;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3">
        <div className="flex flex-col items-center mb-5">
          <img
            src="/logo1.png"
            alt="Logo"
            className="w-20 min-[375px]:w-25 min-[425px]:w-30 min-[550px]:w-35 min-[768px]:w-40 min-[1440px]:w-50 h-auto"
          />
          <p className="text-pink-300 text-sm min-[375px]:text-[18px] min-[425px]:text-[20px] min-[550px]:text-[22px] min-[768px]:text-[24px] min-[1440px]:text-[26px] mb-2 font-medium italic">
            Sua vida mais doce ✨
          </p>
        </div>

        <nav className="flex justify-center py-3">
          <div className="flex flex-nowrap justify-center gap-2.5 min-[375px]:gap-3 min-[425px]:gap-4 min-[550px]:gap-7 min-[768px]:gap-10 min-[1024px]:gap-14 min-[1440px]:gap-16  w-full max-w-[320px]">
